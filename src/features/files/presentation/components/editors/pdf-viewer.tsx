...
/* NOTE: nothing imports this component — the PDF surface the app actually shows is
   @files/presentation/components/media-viewers/pdf-viewer.tsx, which embeds the browser's own viewer in an
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-center gap-2">
        ...
        >
          {t("files.pdf.pageOf", { page, total: numPages || "?" })}
        </span>
        <Button
          variant="ghost"
          size="icon"
