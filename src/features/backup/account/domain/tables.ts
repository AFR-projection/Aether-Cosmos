...
const FILES_TABLES: readonly AccountTable[] = [
  ...
  },
  {
    ...
    columns: {
      ...
      media_duration_ms: { rule: "drop", why: "derived" },
      media_width: { rule: "drop", why: "derived" },
      media_height: { rule: "drop", why: "derived" },
      media_fps: { rule: "drop", why: "derived" },
      media_video_codec: { rule: "drop", why: "derived" },
      media_audio_codec: { rule: "drop", why: "derived" },
      media_bitrate_bps: { rule: "drop", why: "derived" },
      media_container: { rule: "drop", why: "derived" },
      media_faststart: { rule: "drop", why: "derived" },
      media_compatible: { rule: "drop", why: "derived" },
      media_compatibility_reason: { rule: "drop", why: "derived" },
      media_inspected_at: { rule: "drop", why: "derived" },
