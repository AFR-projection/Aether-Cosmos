...
import type { Brain } from "@brain/presentation/hooks/use-brain";

/**
 * Switches which brain every /brain page reads.
 *
 * The choice lives in @brain/domain/active-brain (localStorage + an external store),
