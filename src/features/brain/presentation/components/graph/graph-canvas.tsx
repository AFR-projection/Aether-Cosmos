  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        role="application"
        aria-label={t("brain.graph.canvasLabel")}
        tabIndex={0}
        onKeyDown={onKeyDown}
      ...
      <div className="absolute right-3 top-3 flex flex-col gap-1.5">
        <Button
          ...
          variant="secondary"
          size="icon-sm"
          aria-label={t("brain.graph.zoomIn")}
          onClick={onZoomIn}
        >
        ...
        <Button
          ...
          variant="secondary"
          size="icon-sm"
          aria-label={t("brain.graph.zoomOut")}
          onClick={onZoomOut}
        >
        ...
        {onToggleFullscreen ? (
          <Button
            ...
            size="icon-sm"
            aria-label={
              fullscreen ? t("brain.graph.exitFullscreen") : t("brain.graph.fullscreen")
            }
        ...
        {onPopOut ? (
          <Button
            ...
            variant="secondary"
            size="icon-sm"
            aria-label={t("brain.graph.popOut")}
            onClick={onPopOut}
          >
