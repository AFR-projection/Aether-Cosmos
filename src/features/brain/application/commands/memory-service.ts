...
import { deleteDerivedEdgesFor } from "@brain/application/commands/derived-link-service";
import { relateJobId } from "@brain/application/commands/relate-jobs";
import { embedJobId } from "@brain/infrastructure/providers/embed-jobs";
 ...
 *
 * Uses the shared @/shared/lib/search/fts helpers, which build the tsquery inside Postgres
