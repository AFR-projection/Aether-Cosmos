...
import { memories, memoryMentions, memoryTagMap, memoryLinks } from "@/shared/infrastructure/db/schema";
import { ftsAnyMatchOn, ftsAnyRankOn } from "@/shared/lib/search/fts";
import { STOP_WORDS, type RelateMemory } from "@brain/domain/graph/relate";
...
export async function generateCandidates(
  ...
  //
  // Uses the shared @/shared/lib/search/fts helpers so the tsquery config ('simple') matches
