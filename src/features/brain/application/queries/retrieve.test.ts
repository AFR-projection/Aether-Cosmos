...
import { setEmbeddingProviderForTests } from "@brain/infrastructure/providers/provider";
import {
...
describe("the SQL keeps retrieval's invariants", () => {
  const source = readFileSync("src/features/brain/application/queries/retrieve.ts", "utf8");
