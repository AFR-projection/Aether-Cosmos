...
import { brains, brainAccess, memories, users } from "@/shared/infrastructure/db/schema";
import { rememberMemory } from "./commands/remember";
import { updateMemory } from "./commands/memory-service";
import { enrichMemory } from "./jobs/enrich-service";
import { linkMemory } from "./commands/link-service";
import { recallBrainContext } from "./queries/recall";
import { buildBrainContext } from "./queries/context-engine";
...
import { getMemoryTimeline } from "./queries/temporal-service";
import { getMemoryProvenance } from "./queries/provenance-service";
import { getBrainHealth } from "./queries/health-service";
 ...
 *
 *   DATABASE_URL=postgres://... npx vitest run src/features/brain/application/integration.test.ts
 */
