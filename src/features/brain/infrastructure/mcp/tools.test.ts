...
vi.mock("@brain/application/commands/memory-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
...
vi.mock("@brain/application/queries/graph-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
...
vi.mock("@brain/application/commands/link-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  getMemoryLinks: (...args: unknown[]) => getMemoryLinks(...args),
  linkMemory: (...args: unknown[]) => linkMemory(...args),
}));

vi.mock("@brain/application/commands/consolidation-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  consolidateBrain: (...args: unknown[]) => consolidateBrain(...args),
}));

vi.mock("@brain/application/queries/context-engine", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  buildBrainContext: (...args: unknown[]) => buildBrainContext(...args),
}));

vi.mock("@brain/application/queries/path-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  findBrainMemoryPath: (...args: unknown[]) => findBrainMemoryPath(...args),
}));

vi.mock("@brain/application/queries/related-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  getBrainRelatedMemories: (...args: unknown[]) => getBrainRelatedMemories(...args),
}));

vi.mock("@brain/application/queries/temporal-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  getMemoryTimeline: (...args: unknown[]) => getMemoryTimeline(...args),
}));

vi.mock("@brain/application/queries/provenance-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  getMemoryProvenance: (...args: unknown[]) => getMemoryProvenance(...args),
}));

vi.mock("@brain/application/queries/health-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  getBrainHealth: (...args: unknown[]) => getBrainHealth(...args),
}));

vi.mock("@brain/application/commands/review-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  syncBrainReviewQueue: (...args: unknown[]) => syncBrainReviewQueue(...args),
}));

vi.mock("@brain/application/queries/feedback-loop", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
  recordMemoryFeedback: (...args: unknown[]) => recordMemoryFeedback(...args),
}));

vi.mock("@brain/application/commands/project-service", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
...
vi.mock("@brain/application/commands/remember", async (importOriginal) => ({
  ...(await importOriginal<Original>()),
