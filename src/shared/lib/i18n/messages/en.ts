...
export const en = {
  ...
  files: {
    ...
    subtitles: {
      ...
      actions: {
        ...
        edit: "Edit subtitles",
        editSegmented: "Editing isn't available for subtitle tracks this large yet.",
  ...
  admin: {
    ...
    subtitles: {
      ...
      emergencyPause: "Accept new subtitle work",
      emergencyPauseHint:
        "Turn this off for an emergency pause. Existing workers may finish leased work, but users cannot queue anything new.",
      advancedUnavailable:
        "Provider profiles are not available on this deployment yet. Legacy settings remain readable through the API.",
      profileEnabled: "Use this profile",
      profileName: "Profile name",
      provider: "Provider",
      lastChecked: "Last checked {date}",
      testOk: "Reached {model} in {latency} ms.",
      profiles: {
        asr: { primary: "Transcription primary", fallback: "Transcription fallback" },
        translation: { primary: "Translation primary", fallback: "Translation fallback" },
      },
      health: {
        unknown: "Not checked",
        healthy: "Healthy",
      ...
      controls: {
        ...
        rate: "Requests / minute (0 = unlimited)",
        burst: "Burst allowance",
      },
      operational: {
        heading: "Operational status",
        lede: "Live durable-pipeline counts from this server. No estimate or placeholder data is shown.",
        accepting: "Accepting work",
        paused: "Emergency pause",
        activeRuns: "Active runs",
        pendingWork: "Pending / retry work",
        leasedWork: "Leased work",
        failedRuns: "Failed runs",
        backfill:
          "Library backfill: {status}; processed {processed} of {scanned}, with {failed} failures.",
        backfillNotStarted: "No library backfill state has been recorded.",
        unavailable: "Operational tables are not available on this deployment.",
      },
      allowance: {
