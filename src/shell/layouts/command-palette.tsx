...
const NAV_ITEMS = [
  ...
  { href: "/brain/agents", labelKey: "palette.agents", icon: Bot, descKey: "palette.agentsHint" },
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="scrim fixed inset-0 z-[100] flex items-start justify-center pt-[15vh]"
            ...
            <div className="max-h-80 overflow-auto p-2">
                  ...
                  {NAV_ITEMS.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-xs text-muted-foreground/60">{t(item.descKey)}</p>
                      </div>
              ...
              {query && results.length === 0 && (
                <div className="flex flex-col items-center py-10 text-muted-foreground">
                  ...
                  <p className="text-sm font-medium">{t("palette.noResults")}</p>
                  <p className="text-xs text-muted-foreground/50">{t("palette.noResultsHint")}</p>
                </div>
              )}
            </div>
