...
import { emitQuickAction, type QuickAction } from "@/shared/lib/system/quick-actions";
...
const ACTIONS: {
  ...
  { key: "upload", labelKey: "quickActions.upload", descKey: "quickActions.uploadHint", icon: Upload },
  { key: "note", labelKey: "quickActions.note", descKey: "quickActions.noteHint", icon: FileText },
  { key: "folder", labelKey: "quickActions.folder", descKey: "quickActions.folderHint", icon: FolderPlus },
];
      ...
      {open && (
        <>
          <motion.div
            ...
            /* The dialog tier (80 in the LAYER scale, @/ui/primitives/modal.tsx). It used
          ...
          >
            ...
            <div className="px-3 pb-4">
              {ACTIONS.map(({ key, labelKey, descKey, icon: Icon }) => (
                <button
                  key={key}
                  type="button"
                  data-sheet-focusable
                ...
                >
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="block text-xs text-muted-foreground/70">{t(descKey)}</span>
                  </span>
                </button>
              ))}
            </div>
