...
-- Date: 2026-08-26
--
-- Normalize the outbound-mail identity to "Aether Cosmos ByAFR".
--
-- Two statements:
...
--
-- Nothing else in the rebrand touches the database: rows are keyed by id and
-- encryption compatibility is handled by the mail crypto version reader.
--
...
UPDATE "mail_senders"
 ...
 WHERE md5("from_name") = '3df3b9c00cc9d58c79d96941c3a8d05a';
