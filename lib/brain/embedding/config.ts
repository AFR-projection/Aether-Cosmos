...
import { brainEmbeddingSettings, EMBEDDING_DIMENSIONS } from "@/lib/db/schema";
 ...
 *
 * A 30s in-process cache mirrors `lib/admin-settings.ts`: retrieval reads the config on
